...
import { StyleSheet, Text, View, TextInput, TouchableOpacity, FlatList, Modal, Image, Animated, Alert } from 'react-native';
      ...
      <Modal visible={isProfileModalVisible} animationType="none" transparent={true}>
        <Animated.View style={[styles.profileModalContainer, { transform: [{ scale: profileScaleAnimation }] }]}>
          <View style={styles.profileModalContent}>
            <TouchableOpacity onPress={openImagePicker} style={styles.profileImageContainer}>
              {profileImage ? (
            ...
            <TouchableOpacity onPress={closeProfileModal} style={styles.closeProfileButton}>
...
const styles = StyleSheet.create({
    ...
    additionalButtonsContainer: {
      position: 'absolute',
      bottom: 110, // Isso garante que os botões fiquem acima do botão "+"
      right: 20,
      backgroundColor: '#fff',
      borderRadius: 10,
      elevation: 5,
